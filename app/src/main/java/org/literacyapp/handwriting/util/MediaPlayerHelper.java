package org.literacyapp.handwriting.util;
...
public class MediaPlayerHelper {
    ...
    private static final String INSTRUCTION_LETTER_4 = "use_your_finger_to_draw_the_letter";
    ...
    public static MediaPlayer playInstructionSound(Context context){
        ...
        instructionList.add(INSTRUCTION_LETTER_1);
        instructionList.add(INSTRUCTION_LETTER_2);
        instructionList.add(INSTRUCTION_LETTER_3);
        instructionList.add(INSTRUCTION_LETTER_4);
