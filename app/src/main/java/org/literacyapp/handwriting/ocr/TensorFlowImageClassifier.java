...
public class TensorFlowImageClassifier implements Classifier {
    ...
    public static Classifier create(
        ...
        Log.i(TensorFlowImageClassifier.class.getName(), "Reading labels from: " + actualFilename);
        ...
        Log.i(TensorFlowImageClassifier.class.getName(), "Read " + c.labels.size() + " labels, output layer size is " + numClasses);
